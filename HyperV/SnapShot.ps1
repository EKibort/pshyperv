...
{# .ExternalHelp  MAML-VMSnapshot.XML
    ...
    process{
        ...
        if ($vm.__CLASS -eq 'Msvm_ComputerSystem') {
            ...
            else {$Snaps=Get-WmiObject -computerName $vm.__server -NameSpace $HyperVNameSpace -Query "Select * From MsVM_VirtualSystemSettingData Where VirtualSystemIdentifier='$($VM.name)' and instanceID <> 'Microsoft:$($VM.name)' and elementName like '$name' " 
